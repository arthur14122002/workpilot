...
const SAVED_KEY = "workpilot_saved_offers";
...
<div><strong>Angebotsnummer:</strong> ${escapeHtml(draft.offerNumber)}</div>
<div><strong>Datum:</strong> ${escapeHtml(draft.offerDate)}</div>
<div><strong>Gültig bis:</strong> ${escapeHtml(draft.validUntil)}</div>
</div>
</div>
` : `
<div class="followPageHeader">
Angebot ${escapeHtml(draft.offerNumber)} · ${escapeHtml(draft.recipientName || "")}
</div>
`}

<div class="offerContent">
${isFirstPage ? `
<h2 class="offerTitle">Angebot</h2>
...
<p class="paymentTerm">Zahlungsziel: ${escapeHtml(company.paymentTerm || "14 Tage ab Angebotsdatum")}.</p>
...
introText:
"vielen Dank für Ihren Auftrag. Für die erbrachten Leistungen stellen wir Ihnen folgende Rechnung:",

closingText:
"Bitte überweisen Sie den Rechnungsbetrag innerhalb des angegebenen Zahlungsziels."
};

delete invoice.offerNumber;
delete invoice.offerDate;
...
showToast("Rechnung wird erstellt.");
